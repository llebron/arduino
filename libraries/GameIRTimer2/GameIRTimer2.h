 ...
 * GameIRSend is a stand-alone tramsitter(sends on dig pin 3)
 ...
 *
 * !!!IR led must be connected to transmit from digital pin 3!!!
 *
 * !!!Uses Timer 2 and disables PWM on pins 3 and 11!!!
 * 
...
#ifndef GAME_IR_TIMER_2_H
#define GAME_IR_TIMER_2_H
